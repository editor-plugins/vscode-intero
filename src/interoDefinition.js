...
let InteroDefinitionProvider = (function () {
    function InteroDefinitionProvider() {}

    InteroDefinitionProvider.prototype.provideDefinition = function (document, position, token) {
    ...
    return InteroDefinitionProvider
}())

module.exports = {
    InteroDefinitionProvider
}
